<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminBookInventry.aspx.cs" Inherits="E_LibraryManagement.adminBookInventry" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img id="imgview" Height="150px" Width="100px" src="images/imgs/books.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
